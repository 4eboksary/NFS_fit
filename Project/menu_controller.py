...
# Створюємо кнопки
play_button = ButtonImage(Globals.WIDTH / 2, Globals.HEIGHT / 2, 300, 130, 'images/button_play.png')
set_button = ButtonImage(Globals.WIDTH / 2 - 75, Globals.HEIGHT / 3 * 2, 100, 100, 'images/button_settings.png')
exit_button = ButtonImage(Globals.WIDTH / 2 + 75, Globals.HEIGHT / 3 * 2, 95, 95, 'images/button_exit.png')

resol_button = ButtonImage(Globals.WIDTH / 2, Globals.HEIGHT / 2, 300, 120, 'images/button_resolution.png')
back_button = ButtonImage(Globals.WIDTH / 2, Globals.HEIGHT / 10 * 9, 200, 100, 'images/button_back.png')

small_res_button = ButtonImage(Globals.WIDTH / 2, Globals.HEIGHT / 7 * 2, 325, 145, 'images/small_resol_button.png')
medium_res_button = ButtonImage(Globals.WIDTH / 2, Globals.HEIGHT / 7 * 3, 295, 105, 'images/medium_resol_button.png')
big_res_button = ButtonImage(Globals.WIDTH / 2, Globals.HEIGHT / 7 * 4, 280, 135, 'images/big_resol_button.png')
...
def car_chooser():
    path_arrow = join('images', 'arrow_left.png')
    ...
    second_play_button = ButtonImage(Globals.WIDTH * 0.5, Globals.HEIGHT * 0.7, 100, 100,
                                     join('images', 'button_second_play.png'))
