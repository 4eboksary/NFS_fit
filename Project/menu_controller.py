...
#Створюємо кнопки
play_button = ButtonImage(Globals.WIDTH / 2 - (300 / 2), 300, 300, 130, join('images','buttons', 'button_play.png'))
set_button = ButtonImage(Globals.WIDTH / 2 - (260 / 2), 420, 100, 100, join('images','buttons','button_settings.png'))
exit_button = ButtonImage(Globals.WIDTH / 2 + 27, 420, 95, 95, join('images','buttons','button_exit.png'))

resol_button = ButtonImage(Globals.WIDTH / 2 - (300 / 2), 250, 300, 120, join('images','buttons','button_resolution.png'))
back_button = ButtonImage(Globals.WIDTH / 2 - (200 / 2), 475, 200, 100, join('images','buttons','button_back.png'))

small_res_button = ButtonImage(Globals.WIDTH / 2 - (325 / 2), 125, 325, 145, join('images','buttons','small_resol_button.png'))
medium_res_button = ButtonImage(Globals.WIDTH / 2 - (295 / 2), 250, 295, 105, join('images','buttons','medium_resol_button.png'))
big_res_button = ButtonImage(Globals.WIDTH / 2 - (280 / 2), 340, 280, 135, join('images','buttons','big_resol_button.png'))
